...
export function LeetCodeCard({ data, loading }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-10">
        <img src='/assets/leetcode.png' className='h-12 filter sepia brightness-110 drop-shadow-lg' style={{ filter: 'sepia(0.8) hue-rotate(35deg) brightness(1.2)', backgroundColor: 'transparent' }} alt="LeetCode" />
      ...
      {loading ? (
        ...
        <>
          <div className="mb-6">
            <span className="font-mono text-[12px] uppercase tracking-widest text-[#e9c176] font-bold">
              Knight
            </span>
          </div>
          ...
          {contestRating && (
            <div className="flex items-baseline gap-3 mb-2">
              <span className="text-6xl font-serif text-[#e9c176]">
          ...
          <div className="pt-8 mt-8 border-t border-white/5 flex gap-10">
            {topPercentage && (
              <div>
                ...
                <p className="text-lg font-serif">Top {topPercentage.toFixed(1)}%</p>
              </div>
            )}
          </div>
